...
[Icons]
Name: "{userdesktop}\Brightspace Automator"; Filename: "{app}\python\pythonw.exe"; Parameters: """{app}\gui.py"""; IconFilename: "{app}\icon.ico"; WorkingDir: "{app}"
Name: "{group}\Brightspace Automator"; Filename: "{app}\python\pythonw.exe"; Parameters: """{app}\gui.py"""; IconFilename: "{app}\icon.ico"; WorkingDir: "{app}"
